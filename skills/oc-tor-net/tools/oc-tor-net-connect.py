...
def main(invite_code: str):
    ...
    # Check daemon is running (needed for SOCKS proxy and handshake)
    ...
    peer_transport = invite.get('transport', 'tor')
    network_addr = invite.get('address', invite.get('onion', ''))
    ...
    print(f"Transport:    {peer_transport}")
    ...
    # Read our network address from daemon config
    ...
    if our_address:
        ...
        print("  Warning: Could not determine our network address for handshake.")
